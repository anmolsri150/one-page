          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.html#aboutus">About Us</a>
						...
						<li class="nav-item">
              <a class="nav-link" href="index.html#meetus">The team</a>
            </li>
            <li class="nav-item">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					...
					<strong>Hey there!</strong> Use any password email combination to login.
					</div>
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email" placeholder="Email" value="<?php echo $username; ?>">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" redi="dashboard.html">
							Login
						</button>
					</div>
